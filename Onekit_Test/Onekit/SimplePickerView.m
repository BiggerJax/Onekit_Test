...
-(id)initWithTitle:(NSString*)title view:(UIView*)view array:(NSArray*)array delegate:(id<SimplePickerViewDelegate>)delegate
{
    ...
    if (self) {
        ...
        [_cancelButton setTitleColor:[OKColor fromString:@"#3083FB"]forState:UIControlStateNormal];
        ...
        [_confirmButton setTitleColor:[OKColor fromString:@"#3083FB"]forState:UIControlStateNormal];
