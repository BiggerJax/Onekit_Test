...
//        _datePicker.date = [NSDate date];
        ...
        [_dateCancelButton setTitleColor:[OKColor fromString:@"#3083FB"]forState:UIControlStateNormal];
        ...
        [_dateConfirmButton setTitleColor:[OKColor fromString:@"#3083FB"]forState:UIControlStateNormal];
